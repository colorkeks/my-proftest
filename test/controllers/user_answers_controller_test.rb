...
class UserAnswersControllerTest < ActionController::TestCase
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post :create, user_answer: { correct: @user_answer.correct, point: @user_answer.point, task_id: @user_answer.task_id, task_result_id: @user_answer.task_result_id, text: @user_answer.text }
    end
  ...
  test "should update user_answer" do
    patch :update, id: @user_answer, user_answer: { correct: @user_answer.correct, point: @user_answer.point, task_id: @user_answer.task_id, task_result_id: @user_answer.task_result_id, text: @user_answer.text }
    assert_redirected_to user_answer_path(assigns(:user_answer))
  end
