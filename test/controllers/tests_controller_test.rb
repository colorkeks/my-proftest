...
class TestsControllerTest < ActionController::TestCase
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post :create, test: { admin_id: @test.admin_id, description: @test.description, title: @test.title }
    end
  ...
  test "should update test" do
    patch :update, id: @test, test: { admin_id: @test.admin_id, description: @test.description, title: @test.title }
    assert_redirected_to test_path(assigns(:test))
  end
