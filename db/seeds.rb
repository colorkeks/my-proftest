...
# Role.create!(:name => :Супер_Администратор)
...
# User.create(first_name: 'Регистратор', last_name: 'Регистратор', second_name: 'Регистратор', job: 'Регистратор', roles: [Role.find_by_name(:Регистратор)], email: 'reg@reg.ru', password: '1234qwer', password_confirmation: '1234qwer')
# User.create(first_name: 'Супер', last_name: 'Админ', second_name: 'Админович', job: 'Супер Админ', roles: [Role.find_by_name(:Супер_Администратор)], email: 'super@admin.ru', password: '1234qwer', password_confirmation: '1234qwer')
